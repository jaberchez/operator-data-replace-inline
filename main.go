...
func main() {
	...
	// Sanity checks
	if len(namespace) == 0 {
		setupLog.Error(fmt.Errorf("environment variable NAMESPACE not found"), "controller")
		os.Exit(1)
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f4863781.example.com",
	})
	if err != nil {
	...
	if err = (&controllers.DataReplaceInlineReconciler{
